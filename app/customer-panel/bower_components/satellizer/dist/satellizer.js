...
(function (global, factory) {
    ...
    var Config = (function () {
        function Config() {
            this.baseUrl = '/';
            this.loginUrl = '/auth/authentication';
            ...
            this.providers = {
                ...
                github: {
                    name: 'github',
                    url: '/auth/github',
                    authorizationEndpoint: 'https://github.com/authentication/oauth/authorize',
                    redirectUri: window.location.origin,
                ...
                live: {
                    name: 'live',
                    url: '/auth/live',
                    authorizationEndpoint: 'https://authentication.live.com/oauth20_authorize.srf',
                    redirectUri: window.location.origin,
                    requiredUrlParams: ['display', 'scope'],
                    scope: ['wl.emails'],
                    scopeDelimiter: ' ',
